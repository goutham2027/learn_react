...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"Book.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function Book(props) {
    ...
    _this.handleBorrow = _this.handleBorrow.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(Book, [{
    key: "handleBorrow",
    value: function handleBorrow(event) {
      var _this2 = this;
      ...
      if (this.state.borrowed_count < this.state.count) {
        this.setState(function (state) {
          return {
            borrowed_count: _this2.state.borrowed_count + 1
          };
        });
      }
    ...
    value: function handleReturn(event) {
      ...
      if (this.state.borrowed_count >= 0 && this.state.borrowed_count <= 10) {
        this.setState({
          borrowed_count: this.state.borrowed_count - 1
        });
      }
    }
  }, {
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h3", null, " Title: ", this.props.title, " "), _react.default.createElement("h3", null, " Author: ", this.props.author, " "), _react.default.createElement("p", null, this.state.count - this.state.borrowed_count), this.canBorrow() ? _react.default.createElement("button", {
        onClick: this.handleBorrow,
        isbn: this.props.isbn
      }, " Borrow") : _react.default.createElement("p", null), this.canReturn() ? _react.default.createElement("button", {
        onClick: this.handleReturn,
        isbn: this.props.isbn
      }, " Return ") : _react.default.createElement("p", null), _react.default.createElement("hr", null));
    }
  }]);
...
},{"react":"../node_modules/react/index.js"}],"NewBookForm.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(NewBookForm, _React$Component);

  function NewBookForm(props) {
    var _this;

    _classCallCheck(this, NewBookForm);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(NewBookForm).call(this, props));
    _this.state = {
      title: '',
      author: '',
      copies: 1
  ...
  _createClass(NewBookForm, [{
    ...
    value: function render() {
      var _this$props = this.props,
          handleOnSubmit = _this$props.handleOnSubmit,
          handleInputChange = _this$props.handleInputChange,
          author = _this$props.author,
          title = _this$props.title,
          copies = _this$props.copies;
      return (// <form onSubmit={this.handleOnSubmit}>
        ...
        }, "Number of copies", _react.default.createElement("input", {
          type: "text",
          name: "copies",
          value: copies,
          onChange: handleInputChange
...
var _default = NewBookForm;
exports.default = _default;
},{"react":"../node_modules/react/index.js"}],"Books.js":[function(require,module,exports) {
"use strict";
...
var _NewBookForm = _interopRequireDefault(require("./NewBookForm"));
...
function (_React$Component) {
  ...
  _createClass(Books, [{
    key: "get_default_books",
    value: function get_default_books() {
      return [{
    ...
    key: "handleNewBook",
    value: function handleNewBook(event) {
      event.preventDefault();
      var newBook = {
      ...
      this.setState(function (prevState) {
        return {
          'books': _toConsumableArray(prevState.books).concat([newBook])
        };
      });
    }
  }, {
    ...
    value: function render() {
      ...
      this.state.books.forEach(function (book, index) {
        books.push(_react.default.createElement(_Book.default, {
          key: index,
          title: book.title,
          author: book.author,
          count: book.count
      ...
      return _react.default.createElement("div", null, _react.default.createElement(_NewBookForm.default, {
        handleOnSubmit: this.handleNewBook,
        title: this.state.title,
        author: this.state.author,
        copies: this.state.copies,
        handleInputChange: this.handleInputChange
      }), _react.default.createElement("h2", null, " All Books "), books);
    }
  }]);
...
var _default = Books;
exports.default = _default;
},{"react":"../node_modules/react/index.js","./Book":"Book.js","./NewBookForm":"NewBookForm.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  _createClass(App, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h1", null, " Welcome to BeautifulCode Library "), _react.default.createElement(_Books.default, null));
    }
  }]);
...
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./Books":"Books.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
